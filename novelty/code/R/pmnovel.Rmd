...
novel %>%
  ggplot() + 
    geom_point(aes(year, idx), color = "skyblue3") + 
    scale_x_continuous(breaks = seq(1845, 2015, 10)) + 
    scale_y_continuous(breaks = seq(0, 8000, 1000)) + 
    labs(y = "\"novel\" articles / 100 000 articles",
         x = "year published [DP]",
...
novel %>%
  ggplot() + 
    geom_point(aes(year, idx), color = "skyblue3") + 
    scale_x_continuous(breaks = seq(1845, 2015, 10)) + 
    labs(y = "\"novel\" articles / 100 000 articles (log10 scale)", 
         x = "year published [DP]",
         title = "PubMed articles containing \"novel\" in title or abstract 1845 - 2014") +
    scale_y_log10()
```
