...
## Introduction
This is the latest report on retracted publications in the [PubMed database](http://www.pubmed.gov). It was generated on March 22 2017. This report replaces the application PMRetract, formerly hosted at [Heroku](https://www.heroku.com).
...
<div id = 'chart1b102c0515a7' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b102c0515a7",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart1b102c0515a7",
"chart": {
 "renderTo": "chart1b102c0515a7" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart1b10271587b1' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b10271587b1",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart1b10271587b1",
"chart": {
 "renderTo": "chart1b10271587b1" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart1b10157a2c5d' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b10157a2c5d",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart1b10157a2c5d",
"chart": {
 "renderTo": "chart1b10157a2c5d" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart1b104ea20d3e' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b104ea20d3e",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart1b104ea20d3e",
"chart": {
 "renderTo": "chart1b104ea20d3e" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart1b107aff415a' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b107aff415a",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart1b107aff415a",
"chart": {
 "renderTo": "chart1b107aff415a" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart1b107084ad49' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b107084ad49",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart1b107084ad49",
"chart": {
 "renderTo": "chart1b107084ad49" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart1b101917e679' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b101917e679",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
<div id = 'chart1b10462a5e3b' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b10462a5e3b",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"xAxis": [
 {
 "categories": [ "J. Biol. Chem.", "Proc. Natl. Acad. Sci. U.S.A.", "Science", "Nature", "PLoS ONE", "Anesth. Analg.", "J. Immunol.", "Can J Anaesth", "Tumour Biol.", "Biochem. Biophys. Res. Commun.", "Mol. Biol. Rep.", "Cell", "Diagn Pathol", "Blood", "Eur J Anaesthesiol", "J. Am. Chem. Soc.", "J. Clin. Invest.", "J. Neurosci.", "EMBO J.", "Cancer Res." ],
"labels": {
...
<div id = 'chart1b10226afa02' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b10226afa02",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
<div id = 'chart1b10458cc9d5' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart1b10458cc9d5",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"xAxis": [
 {
 "categories": [ "Diagn Pathol", "Eur. J. Med. Res.", "Eur J Anaesthesiol", "Tumour Biol.", "Mol. Biol. Rep.", "Can J Anaesth", "Cancer Sci.", "Phytother Res", "J Pers Soc Psychol", "Eur Rev Med Pharmacol Sci", "Nat. Prod. Res.", "Anesth. Analg.", "Mol. Endocrinol.", "Genet. Mol. Res.", "Mol. Cell", "FASEB J.", "Acta Anaesthesiol Scand", "ScientificWorldJournal", "Int. J. Syst. Evol. Microbiol.", "Arterioscler. Thromb. Vasc. Biol." ],
"labels": {
 "formatter":  function() { return '<a href=\"http://www.pubmed.gov/?term=%22retraction of  publication%22[PTYP] AND %22' + escape(this.value) + '%22[JOUR]\" target=\"_blank\">' + this.value + '</a>'; } ,
"useHTML": "true" 
} 
