...
## Introduction
This is the latest report on retracted publications in the [PubMed database](http://www.pubmed.gov). It was generated on June 25 2017. This report replaces the application PMRetract, formerly hosted at [Heroku](https://www.heroku.com).
...
<div id = 'chart106b63ae93c4' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b63ae93c4",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart106b63ae93c4",
"chart": {
 "renderTo": "chart106b63ae93c4" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart106b37c82bc2' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b37c82bc2",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart106b37c82bc2",
"chart": {
 "renderTo": "chart106b37c82bc2" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart106b77e79bc5' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b77e79bc5",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart106b77e79bc5",
"chart": {
 "renderTo": "chart106b77e79bc5" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart106b70c7e85c' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b70c7e85c",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart106b70c7e85c",
"chart": {
 "renderTo": "chart106b70c7e85c" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart106b588d8a5b' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b588d8a5b",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart106b588d8a5b",
"chart": {
 "renderTo": "chart106b588d8a5b" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart106b524fc460' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b524fc460",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"id": "chart106b524fc460",
"chart": {
 "renderTo": "chart106b524fc460" 
} 
});
        });
    })(jQuery);
...
<div id = 'chart106b7c5fe5d9' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b7c5fe5d9",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
"xAxis": [
 {
 "categories": [ "J. Biol. Chem.", "Proc. Natl. Acad. Sci. U.S.A.", "Science", "Nature", "Anesth. Analg.", "PLoS ONE", "J. Immunol.", "Can J Anaesth", "Blood", "Obstet Gynecol", "Tumour Biol.", "Cell", "J. Clin. Invest.", "Diagn Pathol", "Mol. Biol. Rep.", "Eur J Anaesthesiol", "Biochem. Biophys. Res. Commun.", "Mol. Cell. Biol.", "J. Neurosci.", "Br J Anaesth" ],
"labels": {
...
<div id = 'chart106b141cb19e' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b141cb19e",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
<div id = 'chart106b1acd1853' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b1acd1853",
"width":            800,
"height":            400,
"credits": {
 "href": null,
...
<div id = 'chart106b3b7f3269' class = 'rChart highcharts'></div>
<script type='text/javascript'>
    (function($){
        $(function () {
            var chart = new Highcharts.Chart({
 "dom": "chart106b3b7f3269",
"width":            800,
"height":            400,
"credits": {
 "href": null,
