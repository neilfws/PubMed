...
-   [Formatting & cleaning the data](#formatting-cleaning-the-data)
-   [Analysis](#analysis)
    -   [Totals](#totals)
    -   [Comments by date](#comments-by-date)
    -   [Comments by year of article publication](#comments-by-year-of-article-publication)
    -   [Comments per article](#comments-per-article)
    -   [Comments per author](#comments-per-author)
    -   [Up/down votes](#updown-votes)
    -   [Moderation](#moderation)
-   [Not yet analysed](#not-yet-analysed)
...
-   final.dataset - total "real" comments; those with author name and comment text (*i.e.* not notes, not moderated)
...
<tbody>
<tr class="odd">
<td align="left">total.records</td>
...
<tr class="even">
<td align="left">unique.articles</td>
<td align="right">6011</td>
</tr>
<tr class="odd">
<td align="left">unique.authors</td>
